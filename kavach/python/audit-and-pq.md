...
```jsonc
{
  ...
  "signed_payload": {
    "data": [123, 34, 112, …],        // bytes of the JSON-serialized audit payload (principal_id, action_name, verdict, verdict_detail, timestamps, optional fields)
